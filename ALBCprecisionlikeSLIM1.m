function [llf, CC, QQ, RR1, arows, acols, asortndx, brows, bcols, bsortndx] = ...
    ALBCprecisionlikeSLIM1(aaa,invbbb,ccc,y,x0,invsqrtsig0,CC,QQ,RR1,arows, acols, asortndx, brows, bcols, bsortndx)
...
%% direct
PP                = [Ptilde22 Ptilde21; Ptilde12 Ptilde11];
sqrtPP            = chol(PP, 'lower');
x1dev             = sqrtPP(N2+1:end,N2+1:end)' * x1tilde;
logdetX11         = 2 * sum(log(diag(sqrtPP(N2+1:end,N2+1:end)))); 
